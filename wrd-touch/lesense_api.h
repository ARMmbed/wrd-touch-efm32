...
#if defined(YOTTA_CFG_HARDWARE_WRD_TOUCH)
#define LESENSE_SAMPLE_DELAY            YOTTA_CFG_HARDWARE_WRD_TOUCH_SAMPLE_DELAY
#define LESENSE_CHANNELS_IN_USE         YOTTA_CFG_HARDWARE_WRD_TOUCH_CHANNELS_IN_USE
#define LESENSE_SCAN_FREQUENCY_LOW      YOTTA_CFG_HARDWARE_WRD_TOUCH_SCAN_FREQUENCY_LOW
#define LESENSE_SCAN_FREQUENCY_HIGH     YOTTA_CFG_HARDWARE_WRD_TOUCH_SCAN_FREQUENCY_HIGH
#define LESENSE_CALIBRATION_VALUES    YOTTA_CFG_HARDWARE_WRD_TOUCH_CALIBRATION_VALUES
#else
